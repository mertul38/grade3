...
# jtab is implemented
# we get one constant (to valC) and one register (to valB)
# we sum them and get the corresponding value to this memory address
# so we get the next instruction address at WriteBack stage after memory
# this results in bubbles: 
# if the decode, execute or memory stage has ijtab, we send nop to next instruction
# after we get memory from (W_valM) we use it as new instruction
...
word f_pc = [
	...
	W_icode == IRET || W_icode == IJTAB: W_valM; # IJTAB added !!!!!!!!!!!!!!!!!!!!!!!!!
...
bool instr_valid = f_icode in 
	{ INOP, IHALT, IRRMOVQ, IIRMOVQ, IRMMOVQ, IMRMOVQ,
	  IOPQ, IJXX, ICALL, IRET, IPUSHQ, IPOPQ, IJTAB }; # IJTAB added !!!!!!!!!!!!!!!!!!!!!!!!!
...
bool need_regids =
	f_icode in { IRRMOVQ, IOPQ, IPUSHQ, IPOPQ, 
	     IIRMOVQ, IRMMOVQ, IMRMOVQ, IJTAB }; # IJTAB added !!!!!!!!!!!!!!!!!!!!!!!!!

# Does fetched instruction require a constant word?
bool need_valC =
f_icode in { IIRMOVQ, IRMMOVQ, IMRMOVQ, IJXX, ICALL, IJTAB }; # IJTAB added !!!!!!!!!!!!!!!!!!!!!!!!!
...
word d_srcB = [
D_icode in { IOPQ, IRMMOVQ, IMRMOVQ, IJTAB  } : D_rB; # IJTAB added !!!!!!!!!!!!!!!!!!!!!!!!!
...
bool F_stall =
	...
	IJTAB in { D_icode, E_icode, M_icode }; # IJTAB added !!!!!!!!!!!!!!!!!!!!!!!!!
...
bool D_bubble =
	...
	&& IRET in { D_icode, E_icode, M_icode } || IJTAB in { D_icode, E_icode, M_icode }; # IJTAB added !!!!!!!!!!!!!!!!!!!!!!!!!
